...
public class BookingServiceTest {
    ...
    void getAllByUserId_stateAll() {
        ...
        when(bookingRepository.findAllByUserId(
                anyLong(), any(Pageable.class))).thenReturn(List.of(booking));

        List<BookingDto> actual = bookingService.getAllByUserId(id, StateType.ALL, 1, 1);
    ...
    void getAllByUserId_stateFuture() {
        ...
        List<BookingDto> actual = bookingService.getAllByUserId(id, StateType.FUTURE, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByUserId_stateCurrent() {
        when(userRepository.existsById(anyLong())).thenReturn(true);
        when(bookingRepository.findAllByUserIdAndStateCurrent(
                anyLong(), any(Pageable.class))).thenReturn(List.of(booking));

        List<BookingDto> actual = bookingService.getAllByUserId(id, StateType.CURRENT, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByUserId_statePast() {
        ...
        List<BookingDto> actual = bookingService.getAllByUserId(id, StateType.PAST, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByUserId_stateWaiting() {
        ...
        List<BookingDto> actual = bookingService.getAllByUserId(id, StateType.WAITING, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByUserId_stateRejected() {
        ...
        List<BookingDto> actual = bookingService.getAllByUserId(id, StateType.REJECTED, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByUserId_shouldThrownExceptionIfUserNotFound() {
        ...
        Throwable exception = assertThrows(
                NotFoundException.class,
                () -> bookingService.getAllByUserId(incorrectId, StateType.ALL, 1, 1));
        assertAll(
                () -> assertNotNull(exception),
                () -> assertEquals(
    ...
    void getAllByOwnerId_stateAll() {
        when(userRepository.existsById(anyLong())).thenReturn(true);
        when(bookingRepository.findAllByItemUserId(
                anyLong(), any(Pageable.class))).thenReturn(List.of(booking));

        List<BookingDto> actual = bookingService.getAllByOwnerId(id, StateType.ALL, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByOwnerId_stateFuture() {
        ...
        List<BookingDto> actual = bookingService.getAllByOwnerId(id, StateType.FUTURE, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByOwnerId_stateCurrent() {
        ...
        List<BookingDto> actual = bookingService.getAllByOwnerId(id, StateType.CURRENT, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByOwnerId_statePast() {
        ...
        List<BookingDto> actual = bookingService.getAllByOwnerId(id, StateType.PAST, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByOwnerId_stateWaiting() {
        ...
        List<BookingDto> actual = bookingService.getAllByOwnerId(id, StateType.WAITING, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByOwnerId_stateRejected() {
        ...
        List<BookingDto> actual = bookingService.getAllByOwnerId(id, StateType.REJECTED, 1, 1);
        assertNotNull(actual.get(0));
    }
    ...
    void getAllByOwnerId_shouldThrowExceptionIfUserNotFound() {
        ...
        Throwable exception = assertThrows(
                NotFoundException.class,
                () -> bookingService.getAllByOwnerId(incorrectId, StateType.ALL, 1, 1));
        assertAll(
                () -> assertNotNull(exception),
                () -> assertEquals(
                        String.format(USER_NOT_FOUND, incorrectId),
